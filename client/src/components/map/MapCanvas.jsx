...
export default function MapCanvas({ sessionId, isDM }) {
  ...
  // loadFog / loadImgTransform : définis avant useMapSocket pour être passés en argument sans TDZ.
  const loadFog = (map) => {
    try {
